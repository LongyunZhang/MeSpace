...
public class HomeActivity extends ActionBarActivity implements View.OnClickListener,
    ...
    //adapter
    private MyexpandableListAdapter adapter; //数据适配器
    //数据库操作
    ...
    private void init() {
        ...
        searchBtn = (ImageView)findViewById(R.id.searchBtn_home);
    ...
    public void onClick(View view) {
        ...
        if(view.getId() == R.id.searchBtn_home){
    ...
    //点击父条目的响应 ---如果返回true的话，点击父条目，子菜单也不会打开
    @Override
